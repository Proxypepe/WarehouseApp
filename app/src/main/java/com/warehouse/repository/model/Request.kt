...
fun toRequest(requestDto: RequestDTO): Request {
    return Request(requestDto.requestID,requestDto.userID, requestDto.productName, requestDto.amount, requestDto.warehousePlace,
        requestDto.status, requestDto.arrivalDate, requestDto.contact, requestDto.price)
}

fun toRequestDTO(request: Request): RequestDTO {
    return RequestDTO(request.id, request.userId, request.productName, request.amount, request.warehousePlace,
